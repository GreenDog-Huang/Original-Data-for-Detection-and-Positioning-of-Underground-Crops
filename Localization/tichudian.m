...
% 2. 读取第一个文件夹的数据
folderPath = 'C:\Users\12865\Desktop\科研\小论文\xlw\实验数据\20241214data_process\original\wusun_Train';
...
% 3. 读取第二个文件夹的数据
folderPath = 'C:\Users\12865\Desktop\科研\小论文\xlw\实验数据\20241214data_process\original\yousun_Train';
filePattern = fullfile(folderPath, '*.csv');
csvFiles = dir(filePattern);
